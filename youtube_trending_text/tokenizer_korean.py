...
if __name__ == "__main__":
    ...
    print(tokenizer_comparison.sentencepiece())
    print(tokenizer_comparison.konlpy_mecab())
    print(tokenizer_comparison.konlpy_komoran())
